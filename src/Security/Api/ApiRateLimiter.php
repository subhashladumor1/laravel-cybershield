...
class ApiRateLimiter
{
    ...
    protected function applyCostBasedRateLimit(Request $request): void
    {
        ...
        if ($cost <= 1 && empty($costs)) {
            // If no costs are defined and current cost is default, we can skip if desired
            // But let's keep it consistent: even default requests have cost 1
        }
